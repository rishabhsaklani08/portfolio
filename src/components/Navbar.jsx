      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer">
            <BouncingLetter letter="R" />
            <BouncingLetter letter="i" />
            <BouncingLetter letter="s" />
            <BouncingLetter letter="h" />
            <BouncingLetter letter="a" />
            <BouncingLetter letter="b" />
            <BouncingLetter letter="h" />
            <BouncingLetter letter="." />
            <BouncingLetter letter="S" />
            <BouncingLetter letter="a" />
            <BouncingLetter letter="k" />
            <BouncingLetter letter="l" />
            <BouncingLetter letter="a" />
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((nav) => (
            <li
              key={nav.id}
              className={
                `${active === nav.title ? "text-white" : "text-violet"} 
